...
namespace MenuMaster.Services
{
    public class RestaurantService : IRestaurantService
    {
        ...
        public async Task<Restaurant> UpdateRestaurantAsync(int restaurantId, UpdateRestaurantDto dto)
        {
        ...
        public async Task<Restaurant?> FindRestaurantByEmailAsync(string email)
        {
